...
[source,java]
----
// first change or install jdk 11 on system environment
// maven install download intellij.tar.gz、intellij-source.zip
mvn clean install -DskipTests=true -P macxos,skipTests
----
